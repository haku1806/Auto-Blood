...
Send("^{a}")
ControlSend("Blood Miner Multilevel v0.9.2 Beta","","[NAME:txtID]",haku1806)

ControlFocus("Blood Miner Multilevel v0.9.2 Beta","","[NAME:txtPassword]")
Send("^{a}")
ControlSend("Blood Miner Multilevel v0.9.2 Beta","","[NAME:txtPassword]",Haku1806)
...
;-----------------CPU Blood------------------------------------------
ControlSend("Blood Miner Multilevel v0.9.2 Beta","","[NAME:cbxCPU]",4)
Sleep(1000)
